...
namespace YAX
{
    ...
    void Game::Draw()
    {
        _impl->_gdService->GraphicsDevice()->Clear(Color::CornflowerBlue);
    }
    ...
    {
        auto gdManager = (IGraphicsDeviceManager*)_impl->_services.GetService<IGraphicsDeviceManager>();
        gdManager->CreateDevice();
